...
int main(int, char**)
{
    ...
    // Load fonts
    ImFont* play_chickens_font = io.Fonts->AddFontFromFileTTF("E:/Aku cinta ngoding/Semester 3/TUBES STRUKDAT/testing aja/engine_project/src/Play Chickens.otf", 30.0f);
    ImFont* roboto_font = io.Fonts->AddFontFromFileTTF("E:/Aku cinta ngoding/Semester 3/TUBES STRUKDAT/testing aja/engine_project/src/Roboto-Regular.ttf", 20.0f);
